...
$query  = "SELECT username, user_quacks, date_posted, quack_id FROM quack WHERE username = '$username' ORDER BY quack_id DESC LIMIT 5 OFFSET $offset;";
...
while ($row = mysqli_fetch_assoc($result)) {
	...
	if ($username == $visitor) {
		$buffer.= "<div id='$quack_id' class=\"container-fluid center-align\" style='margin-bottom: 25px; max-width: 550px;'>
						<div class=\"row br-20px box-shadow bg-white\" style='width: 100%;'>
							<div class=\"col-2\">
